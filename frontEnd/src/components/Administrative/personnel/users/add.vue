		...
		<el-form ref="form" :model="form" :rules="rules" label-width="130px">
			...
			<el-form-item label="部门" prop="structure_id">
				<el-select v-model="form.structure_id" placeholder="请选择部门" class="w-200">
					<el-option v-for="item in orgsOptions" :label="item.title" :value="item.id" :key="item"></el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item label="用户组">
				<el-checkbox-group v-model="selectedGroups">
					<el-checkbox v-for="item in groupOptions" :label="item.title" class="form-checkbox" :key="item"></el-checkbox>
				</el-checkbox-group>
			</el-form-item>
			<el-form-item>
